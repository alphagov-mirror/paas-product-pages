...
GOV.UK PaaS requires that your application is built to meet modern standards. It's easier to migrate to GOV.UK PaaS if your application is â€œ[cloud native](https://thenewstack.io/10-key-attributes-of-cloud-native-applications/)â€ and built using [12 factor application principles](https://docs.cloud.service.gov.uk/architecture.html#12-factor-application-principles).
