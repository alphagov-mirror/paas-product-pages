...
<div class="govuk-notification-banner govuk-notification-banner--success" data-cookie-confirmation="true" role="alert" aria-labelledby="govuk-notification-banner-title" data-module="govuk-notification-banner">
  ...
  <div class="govuk-notification-banner__content">
    ...
    <p class="govuk-body">
      <a class="govuk_link previous-page govuk-!-margin-top-1" href="#">
